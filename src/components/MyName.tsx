  ...
  return (
    ...
    >
        ...
        >
          ...
          <br className="md:block hidden" /> (and designing) exceptional digital experiences. Currently. I&apos;m focused on{" "}
          <br className="md:block hidden" />
          creating and deploying <span className="text-AAsecondary">Mobile and Web Application</span> on the
          Internet.
        </motion.h3>
        <motion.div
          initial={{ y: 10, opacity: 0 }}
