...
const IconsData = [
  { href: "https://github.com/dalis-ops", Icon: GithubIcon },
  { href: "https://www.linkedin.com/in/yugansh-agrawal-286712187/", Icon: LinkedinIcon },
];
    ...
    text-sm  space-y-2  "
        >
          <span className="group-hover:text-AAsecondary sm:text-sm text-xs">
            Designed & Built by Yugansh Agrawal
          </span>
